...
//	         }
	         for(var i=0;i<data.data.length;i++){
	         	 html+='<a href="auditCont.html?'+data.data[i].newid+'"><p><i>'+data.data[i].title+'</i></p><p><i>'+data.data[i].content+'</i></p><p><span>类型：</span><i>css</i><span>发布时间</span><span>'+data.data[i].time+'</span></p>'
	         }
